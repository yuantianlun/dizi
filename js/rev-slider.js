...
(function(t) {
    ...
    if (!e.TweenLite) {
        ...
        var v = [0, 0, 1, 1],
            g = [],
            T = d("http://demo.cssmoban.com/cssthemes4/sbtp_51_moban2234/js/easing.Ease", function(t, e, i, s) {
...
function revslider_showDoubleJqueryError(e) {
    ...
    function S(n, r, i) {
        if (i == t) i == 80;
        setTimeout(function() {
            n.find("http://demo.cssmoban.com/cssthemes4/sbtp_51_moban2234/js/.slotholder .slot").each(function() {
